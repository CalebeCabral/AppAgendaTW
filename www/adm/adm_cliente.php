...
<div class="row clearfix my-4">
	<div class="col-md-6 col-xs-12 d-md-flex justify-content-start search-filter">
		<form class="form-inline px-1">
			<!-- <div class="form-group search-mob">
				<label for="searchBox" class="d-none d-md-block mx-2"><strong>Buscar:</strong></label>
				<input id="searchBox" type="text" class="form-control search-mob" placeholder="Digite um nome...">
			</div> -->
                     ...
                     <td data-title="Tel. 2">
							...
							<td>
								<div class="d-flex justify-content-around">
									...
									<a href="#" class="d-flex flex-column justify-content-center viewButton" data-id="'. $data['id_cli'] .'" data-toggle="modal" data-target="#viewModal" data-type="cliente">
									...
									<a href="update.php?id='. $data['id_cli'] .'&tipo=cli" class="d-flex flex-column justify-content-center ml-md-2">
									...
									<a href="disable.php?id='. $data['id_cli'] .'&tipo=cli" class="d-flex flex-column justify-content-center ml-md-2">
